...
*** Introduction to histograms (45')
	...
	6. Show two different histograms from two people in the same group. Why are they different?
	7. Now add a histogram from a person in another group. Why are those different?
