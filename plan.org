...
Here we can plot the number of people having a certain height and weight combination. This can be done with a colour-map. This is not much different than a normal histogram.

*** Relationships as conditional distribution.

Here we model the distribution of one variable given a fixed value for the other, e.g. $P(X|Y)$. The simplest thing is to 
...
| 2 Dec  |                           |              |                          | Project               |
|--------+---------------------------+--------------+--------------------------+-----------------------|
| 12     | Conditional expectations  |              |                          | Project               |
| 9 Dec  |                           |              | Examples, project work   |                       |
|--------+---------------------------+--------------+--------------------------+-----------------------|
| 13     |                           |              |                          |                       |
| 16 Dec |                           |              | Project presentations    | Project Presentations |
|--------+---------------------------+--------------+--------------------------+-----------------------|
|        |                           |              |                          |                       |
