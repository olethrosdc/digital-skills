...
2. Understanding the randomness, variability and uncertainty inherent
   in a problem.
3. Developing clear statements of the problem/scientific research
   question; understanding the purpose of the answer.
4. Ensuring acquisition of high-quality data and not just a lot of
   numbers.
5. Understanding the process that produced the data, to provide proper
   context for analysis.
6. Allowing domain knowledge to guide both data collection and
   analysis.
7. Quantify uncertainty---and knowledge---visually.
8. Realise that all visualisations are models.
9. Be able to perform a basic experiment design.
10. Identify sources of bias in data collection and analysis.
11. Understand privacy problems and measure.
12. Be able to write simple python programs for data science
    workflows.
#+END_CENTER
