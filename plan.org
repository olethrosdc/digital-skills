...
*** Homework Assignment: Fix a bad plot
...
** Plot deconstruction
In this assignment, you will take a plot from an online source or newspape article, explain it and improve it.


** Newspaper article analysis
In this assignment you will read a newspaper article with some statistics and visualisations, and try to interpret what it says.
...
| 14 Oct | Discrete vars in R        |              | Undercounting            | Deconstruction  |
|        |                           |              | Representative samples   |                 |
|        |                           |              |                          |                 |
|--------+---------------------------+--------------+--------------------------+-----------------|
| 5      | Continous RV              | Functions    | A/B Testing              |                 |
| 21 Oct |                           |              | Comparing two algorithms | Proposal        |
|        |                           |              |                          |                 |
|--------+---------------------------+--------------+--------------------------+-----------------|
