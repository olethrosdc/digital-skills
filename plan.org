...
*** Comparing two populations :activity:	

Here we want to compare the distribution of two populations. Are men
taller than women? Let us start by looking at the class data.

How can we be sure that our conclusion that the two populations are
different in general is correct? How can we generalise from the class data?
...
the options [assume it's just a yes/no vote] in the election gives you 10,000 CHF to spend over these
100 days so as to measure the mood of the population. They can use
that information to better increase their chances of success. How
